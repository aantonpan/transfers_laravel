...
<div class="container">
    ...
    <form action="{{ route('hotel.createReservation.store') }}" method="POST">
        @csrf
         <!-- Tipo de Reserva -->
         <div class="mb-3">
    ...
    <select class="form-control" id="traveler_id" name="traveler_id" required onchange="updateTravelerDetails()">
        <option value="">Selecciona un viajero</option>
        @foreach($travelers as $user) {{-- La variable $travelers contiene usuarios de la tabla users --}}
