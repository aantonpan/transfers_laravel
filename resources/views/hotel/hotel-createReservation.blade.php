...
<div class="container">
    ...
    <select class="form-control" id="user_id" name="user_id" required onchange="updateTravelerDetails()">
        <option value="">Selecciona un viajero</option>
        @foreach($users as $user) {{-- La variable $users contiene usuarios de la tabla users --}}
